...
def get_appropriate_libraries(sample_info, onlyFilter=False):
    ...
    libs_out = []
    if dilution < 100:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-100pg-rep5")
    if dilution < 250:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-250pg-rep1")
    if dilution < 500:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-500pg-rep3")
    if dilution < 1000:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-1000pg-rep2")
    if dilution < 2500:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-2500pg-rep1")
    if dilution < 5000:
        libs_out.append("2025-06-24-Refine-PeptDeep-DIANN-5000pg-rep2")
