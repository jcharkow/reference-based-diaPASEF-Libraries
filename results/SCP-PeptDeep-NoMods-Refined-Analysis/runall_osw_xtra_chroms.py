...
check_create_folder("HeLa02DDM_100pg_5x3_PyDIA_1_S1-C4_1_1630")
check_create_folder("HeLa02DDM_1000pg_5x3_PyDIA_2_S1-D2_1_1649_lib")


check_and_run_sbatch('HeLa02DDM_100pg_5x3_PyDIA_1_S1-C4_1_1630', 
              '../src/run_osw.sh',
              '../data/2025-05-UltraLowDilutions/DDM02/mzML/HeLa02DDM_100pg_5x3_PyDIA_1_S1-C4_1_1630.mzML', 
              'osw/pqp_libraries/HeLa02DDM_1000pg_5x3_PyDIA_2_S1-D2_1_1649_osw_4_6Frags_decoys.pqp',
              'osw/irts/2025-07-25-1000pg-linIrt-PeptDeepNoMods_refined_rep2.tsv', 
              'osw/irts/2025-07-25-1000pg-nonLinIrt-PeptDeepNoMods_refined_rep2.tsv', 
              'HeLa02DDM_100pg_5x3_PyDIA_1_S1-C4_1_1630', 
              'True', 
              '../../bin/sif/openms-executables-sif_3.2.0.sif', 
              '-irt_im_extraction_window 0.2 -ion_mobility_window 0.06 -rt_extraction_window 300')
