...
libPth=../2025-12-02-Refined-PanHuman-Lib-With-GPF-Reannotated-Lib-New-Decoys/osw/

lib=${libPth}/2025-11-26-osw-PHL-gpf-refined-SVM_onlyFilter.tsv
irtLin="../K562-PanHuman-Analysis/formattedLib/2025-05-23-linear-irt.tsv"
irtNonLin="../K562-PanHuman-Analysis/formattedLib/2025-03-06-nonLin-iRT.tsv"
...
do
	...
	checkAndRunSbatch ${output}.osw ${fromMain}/../../results/K562-PanHuman-Lib-Refined-GPF-Analysis/run_osw_tsv.sh ${fromMain}/${mzml} ${fromMain}/${lib} ${fromMain}/${irtNonLin} ${fromMain}/${irtNonLin} ${output} False ${fromMain}/${sigOSW} $additionalParam
	# Convert pyprophet 
	if [[ -f ${output}.osw ]]
	then
