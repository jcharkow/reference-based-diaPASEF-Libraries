...
checkCreateFolder diann_tl

# analyze with the refined library from DIA-NN
lib="../K562-Refine-PanHuman-Lib-With-GPF/diann_transfer_learn/2025-06-10-PanHuman-Lib-Transfer-Learn-GPF-Models-DIANN_fix_mods.tsv"
for d in $d1 $d2 $d3 
do
	...
	## NOTE: because the protein information in the library is in an obscure format, use reannotate to fix this. If do not have this will get 0 IDs reported
	additionalParam="--verbose 1 --direct-quant --mass-acc 15 --mass-acc-ms1 15 --report-lib-info --reannotate"
