...
# use the in-silico generated library from the dilution experiment so do not have to regenerate library 
lib="../PeptDeep-NoMods-In-Silico-Library-Generation/2025-06-10-in-silico-lib-no-mods_fix_mods_filtered.tsv"
outLib="2025-06-18-GPF-Refined-Peptdeep-NoMods-Lib.parquet"
