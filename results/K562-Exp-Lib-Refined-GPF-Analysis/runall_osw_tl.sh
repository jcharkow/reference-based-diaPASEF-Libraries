...
lib=../K562-Refine-Exp-Lib-With-GPF/osw_tl/2025-08-15-Exp-TL-On-GPF-OSW_fix_mods.tsv
irtLinOrig=../K562-Exp-Lib-Analysis/formattedLib/2025-03-06-linear-irt.tsv
irtNonLinOrig=../K562-Exp-Lib-Analysis/formattedLib/2025-03-06-nonLin-iRT.tsv
...
lib=formattedLib_osw_tl/${baseLib/.tsv/_osw_6Frags_decoys.pqp}
...
do
	...
	additionalParam="-irt_im_extraction_window 0.2 -ion_mobility_window 0.06 -rt_extraction_window 300"
	checkAndRunSbatch ${output}.osw ${fromMain}/${scripts}/run_osw.sh ${fromMain}/${mzml} ${fromMain}/${lib} ${fromMain}/formattedLib_osw_tl/${irtLin} ${fromMain}/formattedLib_osw_tl/${irtNonLin} ${output} False ${fromMain}/${sigOSW} $additionalParam
