...
## THIS SCRIPT USES VERY STRICT PI0 TO PREVENT FAILING WITH A VERY GOOD LIBRARY
...
peptideCommand="apptainer exec --cleanenv --no-home --bind ./:/mnt --pwd /mnt ${sig} pyprophet peptide --in=${osw} --context=global --pi0_lambda 0.001 0 0" 
echo ${peptideCommand}
$peptideCommand


proteinCommand="apptainer exec --cleanenv --no-home --bind ./:/mnt --pwd /mnt ${sig} pyprophet protein --in=${osw} --context=global --pi0_lambda 0.001 0 0" 
echo ${proteinCommand}
$proteinCommand
