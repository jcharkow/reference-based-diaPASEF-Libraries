...
lib=${libPth}/2025-07-11-osw-peptdeepNoMods-gpf-refined.tsv

irtPth=../../results/PeptDeep-NoMods-In-Silico-Library-Generation/
irtLinOrig=${irtPth}/2025-05-23-linear-irt.tsv
irtNonLinOrig=${irtPth}/2025-03-06-nonlinear-irt-in-silico.tsv
...
do
	...
	checkAndRunSbatch ${output}.osw ${fromMain}/${scripts}/run_osw.sh ${fromMain}/${mzml} ${fromMain}/${lib} ${fromMain}/formattedLib_osw/${irtLin} ${fromMain}/formattedLib_osw/${irtNonLin} ${output} True ${fromMain}/${sigOSW} $additionalParam
