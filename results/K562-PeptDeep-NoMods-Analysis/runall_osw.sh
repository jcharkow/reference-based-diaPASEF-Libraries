...
do
	...
	checkAndRunSbatch ${output}.osw.zst ${fromMain}/${scripts}/run_osw_tsv.sh ${fromMain}/${mzml} ${fromMain}/${lib} ${fromMain}/${irtLin} ${fromMain}/${irtNonLin} ${output} True ${fromMain}/${sigOSW} $additionalParam
