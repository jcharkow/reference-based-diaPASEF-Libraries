...
###### Rename headers 
lib = lib.rename(columns={'RT':'NormalizedRetentionTime', 'IonMobility':'PrecursorIonMobility', 'ModifiedPeptide':'ModifiedPeptideSequence', 'StrippedPeptide':'PeptideSequence', 'Genes':'ProteinId', 'FragmentMz':'ProductMz', 'FragmentCharge':'ProductCharge', 'FragmentNumber':'FragmentSeriesNumber'}).drop(columns=['FragmentLossType', 'ProteinID'])
