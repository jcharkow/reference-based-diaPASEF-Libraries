...
##########################################
checkAndRun ${lib/.tsv/_6Frags.tsv} singularity exec --bind $(pwd):/mnt -H /mnt ${sigPath} OpenSwathAssayGenerator -in ${lib} -out ${lib/.tsv/_6Frags.tsv} -min_transitions 6 -max_transitions 6 -batchSize 10000000
