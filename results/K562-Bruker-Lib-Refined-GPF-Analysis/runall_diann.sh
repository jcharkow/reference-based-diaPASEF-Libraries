...
###################DIA-NN WORKFLOW ################
##### This uses my custom scripts to create the DIA-NN library
checkCreateFolder diann
lib="../K562-Refine-Bruker-Lib-With-GPF/2025-06-10-diann-bruker-gpf-refined.tsv"
...
################### 	DIA-NN MY LIB WORKFLOW Not done currently ################
