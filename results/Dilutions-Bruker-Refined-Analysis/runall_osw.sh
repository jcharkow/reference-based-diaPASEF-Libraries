...
libPth=../Dilutions-K562-Bruker-Lib/osw/
fromMain="../.."
for lib in $(find ${fromMain}/../Dilutions-K562-Bruker-Lib/osw -wholename "*/pyprophet_XGB/*_lib.tsv")
do
...
for irt in $(find ${fromMain}/../Dilutions-K562-Bruker-Lib/osw -wholename "*/2025-01-21*.tsv")
do
	dilution_irt=${irt%ng*}
