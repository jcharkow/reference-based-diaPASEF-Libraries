#!/bin/bash
# In this workflow use the libraries that were generated from diaTracer and quantify them
#########################
### Run DIA-NN Workflow #
#########################
scripts="../../src"
...
do
	...
	checkAndRunSbatch report.tsv ${fromMain}/${scripts}/run_diann_fasta.sh ${fromMain}/${d} ${fromMain}/${output}/library.tsv ${fromMain}/${fasta} ${fromMain}/${sifDiann} ${additionalParam}
	cd ..
done
