...
parser.add_argument("--top_k_frags", help='# fragments', default=12, required=False, type=int) # get top 20 fragments so that can ensure after OSW Library Assay generated filtering precursors are retained.

frag_inten = 0.001
min_frag_mz = 200
max_frag_mz = 2000
min_frag_nAA = 0
translate_mod_to_unimod_id = True
